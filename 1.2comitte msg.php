<?php include"Dynamic/committ_msg.php"; ?>
...
<body>
	...
	<div class="admin">
		...
		<div class="admin_header"style="background-color:#1d878f">
			...
			<p class="title">Admin [F-Committees]</p>
		...
		<?php
			...
			if(isset($_GET['pd'])){
				...
				$id = $_GET['pd'];
					...
					//Data read.
					$sql = "SELECT * FROM committe_tabl WHERE message_id = '$id';";
		...
		?>
			...
			<form action="Dynamic/committ_msg.php" method="post" class="form message_form" enctype="multipart/form-data">
