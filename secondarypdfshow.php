...
<div class="container">
 ...
 <h1 align="center"><a href="#" class="effect-underline">Notice and news<span style="color:#145DA0;">(Secondary)</span></a></h1>
  ...
  <button class="loading-button"><a href="display_pdf.php"style="color: white;">Primary</a></button>
  <button class="green loading-button"><a href="display_pdf.php"style="color: white;">Secondary</a></button>
</section>-->
    ...
    <div class="about"><div class="div1">
      ...
      $sql="SELECT pdf,Date from secondary_pdf ORDER BY id  DESC";
      ...
      <embed type="application/pdf" src="secondary.pdf/<?php echo $info['pdf'] ; ?>" width="800" height="330">
