...
<body> 
  <div class="wel"> Admin(Image uploads) <a href="../1_admin.php"><i  style="margin-left: 1100px;color: white;" class="fa fa-sign-out" aria-hidden="true"></i></a></div>

<h1 style="text-align: center;font-size: 40px;color: #050A30;margin-top: 150px;">Image uploads</h1>
	<div class="er">
