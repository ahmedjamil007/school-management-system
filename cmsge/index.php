...
<body>
	...
	<nav class="navbar navbar-default" style="background-color:#1d878f;" >
		<div class="container-fluid"style="color:white;">
			<a class="navbar-brand"style="color:white;"  href="Display.php">Contact Reply</a>
		</div>
	</nav>
	<div class="col-md-3"></div>
	<div class="col-md-6 well">
		<h3 class="text-primary">PRIMROSE KINDERGARTEN & SCHOOL</h3>
