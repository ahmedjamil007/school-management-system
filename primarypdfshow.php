...
<div class="container">
 ...
 <h1 align="center"><a href="#" class="effect-underline">Notice and news <span style="color:#145DA0;">(Primary)</span></a></h1>
  ...
  <button class="green loading-button"><a href="display_pdf.php"style="color: white;">Secondary</a></button>
    ...
    <div class="about"><div class="div1">
      ...
      $sql="SELECT pdf,Date from primary_pdf ORDER BY id  DESC";
      ...
      <embed type="application/pdf" src="primarypdf/<?php echo $info['pdf'] ; ?>" width="850" height="330">
