...
<body>
  ...
  <div class="admin">
    ...
    <div class="wel"> News & notice(Secondary)</div>
    
<div class="rt">
      <form class="" action="secondarypdf.php" method="post" enctype="multipart/form-data">
        <label class="qw" for=""><center>Choose Your PDF File</center></label><br>
        <input id="pdf" type="file" name="pdf" value="" required><br><br>
        <input id="upload" type="submit" name="submit" value="Upload">
        <button class="button"> <a href="notic uodate/secondary_display.php">Delete</a> </button>
        <?php
        include 'db.php';
        ...
        if (isset($_POST['submit'])) {
          ...
          $pdf_store="secondary.pdf/".$pdf;

          move_uploaded_file($pdf_tem_loc,$pdf_store);

          $sql="INSERT INTO secondary_pdf(pdf) values('$pdf')";
