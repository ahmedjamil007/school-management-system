    ...
    if(in_array($file_extension, $allowed)){
        ...
        if($file_error === 0){
            ...
            if($file_size < 3200000){
                ...
                //Data insertion.
                $sql = "INSERT INTO messages_table (messenger_name, messenger_position, msg, messenger_picture) VALUES ('$name', '$position', '$message', '$new_file_name');";
                                
                mysqli_query($connection, $sql);
                
                header("Location: ../1.1_messages_admin.php");
...
global $connection; 
        ...
        //Data read.
        $read_messages = "SELECT * FROM messages_table ORDER BY message_id DESC;";
...
//post template
            ...
            echo "<form class='btns' action='Dynamic/messages_actions.php' method='post'>";

            echo    "<input type='hidden' name='id' value='$id'>";

            echo    "<input type='hidden' name='old_pic' value='$pic'>";

            echo    "<div><a href='1.1_messages_admin.php?pd=$id'><i class='fas fa-pen edit'></i></a></div>";
    ...
    if(in_array($file_extension, $allowed)){
        ...
        if($file_error === 0){
            ...
            if($file_size < 3200000){
                ...
                //Data update.
                $sql = "UPDATE messages_table SET messenger_name = '$name', messenger_position = '$position', msg = '$message', messenger_picture = '$new_file_name' WHERE message_id = $id; ";
...
if(isset($_POST['delete_msg'])){
    ...
    // Query.    
    $sql = "DELETE FROM messages_table WHERE message_id = $id; ";
