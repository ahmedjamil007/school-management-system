    ...
    if(in_array($file_extension, $allowed)){
        ...
        if($file_error === 0){
            ...
            if($file_size < 3200000){
                ...
                //Data insertion.
                $sql = "INSERT INTO committe_tabl (messenger_name, messenger_position, msg, messenger_picture) VALUES ('$name', '$position', '$message', '$new_file_name');";
                                
                mysqli_query($connection, $sql);
                
                header("Location: ../1.2comitte msg.php");
...
global $connection; 
        ...
        //Data read.
        $read_messages = "SELECT * FROM committe_tabl ORDER BY message_id DESC;";
...
//post template
            ...
            echo    "<div><a href='1.2comitte msg.php?pd=$id'><i class='fas fa-pen edit'></i></a></div>";
    ...
    if(in_array($file_extension, $allowed)){
        ...
        if($file_error === 0){
            ...
            if($file_size < 3200000){
                ...
                //Data update.
                $sql = "UPDATE committe_tabl SET messenger_name = '$name', messenger_position = '$position', msg = '$message', messenger_picture = '$new_file_name' WHERE message_id = $id; ";
...
if(isset($_POST['delete_msg'])){
    ...
    // Query.    
    $sql = "DELETE FROM committe_tabl WHERE message_id = $id; ";
