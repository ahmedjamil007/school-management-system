<?php include"Dynamic/committe_msg.php"; ?>
...
<body>
	...
	<div class="admin">
		...
		<div class="admin_header"style="background-color:#1d878f">
			...
			<p class="title">Admin [ D-Committees]</p>
		...
		<?php
			...
			if(isset($_GET['pd'])){
				...
				$id = $_GET['pd'];
					...
					//Data read.
					$sql = "SELECT * FROM committe_table WHERE message_id = '$id';";
		...
		?>
			...
			<form action="Dynamic/committe_msg.php" method="post" class="form message_form" enctype="multipart/form-data">
